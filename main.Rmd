...
current_pooled_prior <- data_frame(x=scale, y=dnorm(scale, mean=0, sd=1))
tested_pooled_prior <- data_frame(x=scale, y=dnorm(scale, mean=2, sd=0.3))
...
current_hierarchical_prior_mu <- data_frame(x=scale, y=dnorm(scale, mean=0, sd=1))
tested_hierarchical_prior_mu <- data_frame(x=scale, y=dnorm(scale, mean=2, sd=0.3))

current_hierarchical_prior_sigma <- data_frame(x=scale, y=dnorm(scale, mean=0, sd=1))
tested_hierarchical_prior_sigma <- data_frame(x=scale, y=dnorm(scale, mean=2, sd=0.5))
